def remove_text_after_colon(input_text):
    """
    Remove text after the colon ':' for each line in the input text.
    """
    # Split the input text into lines and process each line
    lines = input_text.splitlines()
    modified_lines = [line.split(':', 1)[0] for line in lines]
    return '\n'.join(modified_lines)
...
result = remove_text_after_colon(input_text)
print("Modified text:")
print(result)
