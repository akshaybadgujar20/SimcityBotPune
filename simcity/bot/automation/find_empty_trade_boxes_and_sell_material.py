...
from simcity.bot.automation.city_utility_actions import click_on_own_material_storage, click_on_city_storage, \
    click_on_purchase_menu, click_on_own_trade_depot, go_to_next_page_in_storage, go_to_next_page_in_city_trade_depot
...
def find_empty_trade_boxes_and_sell_material(materials, device_id, advertise, full_price, max_city_storage_scrolls=15, max_depot_pages=5):
    ...
    current_depot_page = 1
    empty_trade_boxes, _ = find_miscellaneous_material(Miscellaneous.EMPTY_TRADE_BOXES, device_id
                                                       )
    empty_trade_box_index = 0
